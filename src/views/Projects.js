	...
	return (
		<>
			<motion.div
				...
				className='flex flex-col w-full h-full row-start-1 row-span-full col-start-1 col-span-full ml-14 rounded-xl border border-gray-300 shadow-lg select-none'
			>
